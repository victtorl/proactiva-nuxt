...
<div class="mx-7 lg:mx-24 bg-secundary h-[100%] pt-[36px] lg:pt-0">
      <div class="w-full ">
        ...
        <div class="w-full flex justify-center items-center">
               <ul>
                   <li><NuxtLink to="/services/servicio1" >Servicio 1</NuxtLink></li>
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-balance text-4xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-5xl" id="programastitle" >Programas</h2>
    ...
    <div class=" py-16 sm:py-16">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3" id="eventogratis" >
            <CardsWorkshoop 
        :id="item.id"
        :nombre="item.name" 
        :description="item.description" 
