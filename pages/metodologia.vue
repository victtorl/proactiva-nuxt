...
En nuestro enfoque, comprendemos a cada mujer como un ser único y multidimensional. Aplicamos una metodología holística basada en los más recientes hallazgos de la Psicología Positiva, Neurociencias, Programación Neurolingüística (PNL) y Espiritualidad, diseñando intervenciones personalizadas que generan cambios significativos, eficientes y sostenibles.

Si buscas un camino de transformación auténtico y alineado con tu esencia, este métod</p>
  ...
  useSeoMeta({
      ...
      description: `En Centro Proactiva te ayudamos a superar conflictos emocionales a través
       de la reprogramación mental y el desarrollo de tu potencial. Coaches  expertos en empoderamiento
       y bienestar personal en Lima`,
      ogImage: SeoPro,
  ...
  function changeBackground() {
    currentIn.value=obtenerNumeroAleatorio()    
  }
